fn main () {
    ...
    use::linux/init.h;
    use::linux/kernel.h;
    use::linux/kernel_read_file.h;
    use::linux/lsm_hooks.h;
    use::linux/mman.h;
    use::linux/mount.h;
    use::linux/personality.h;
    use::linux/backing-dev.h;
    use::linux/string.h;
    use::linux/xattr.h;
    use::linux/msg.h;
    use::linux/overflow.h;
    use::inclde<linux/perf_event.h;
    use::linux/fs.h;
    use::net/flow.h;
    use::net/sock.h;
    use::security;
